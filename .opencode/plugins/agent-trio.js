 ...
 *
 * Registers the repo-root `skills/` and `agents/` directories with OpenCode
...
- Dispatch builder/reviewer with OpenCode's subagent system (\`@builder\`, \`@reviewer\`). Both wrappers read \`agents/builder.md\` and \`agents/reviewer.md\` from the repo root.
